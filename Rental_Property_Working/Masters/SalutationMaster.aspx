<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true" CodeFile="SalutationMaster.aspx.cs" Inherits="Masters_SalutationMaster" Title="Untitled Page" %>
                        ...
                        <fieldset id="fieldset1" width="90%" runat="server" class="FieldSet">
                            <table width="90%" cellspacing="6">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="TxtSalutation" runat="server" CssClass="TextBox" MaxLength="50" TabIndex="1"
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ID="Req1" runat="server" ControlToValidate="TxtSalutation"
                                            Display="None" ErrorMessage="Salutation is Required" SetFocusOnError="True" ValidationGroup="Add"></asp:RequiredFieldValidator>
                                        <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender2" runat="server" Enabled="True"
                                            TargetControlID="Req1" WarningIconImageUrl="~/Images/Icon/Warning.png">
                                             ...
                                             <ajax:AutoCompleteExtender ID="ACE1" runat="server" TargetControlID="TxtSalutation" CompletionInterval="100"
