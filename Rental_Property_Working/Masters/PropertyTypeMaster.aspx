<%@ Page Title="PropertyType Master" Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master"
    AutoEventWireup="true" CodeFile="PropertyTypeMaster.aspx.cs" Inherits="Masters_PropertyTypeMaster" %>
 ...
 <input type="hidden" id="hiddenbox" runat="server" value="" />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:TextBox ID="TxtSearch" runat="server" CssClass="search" ToolTip="Enter The Text" TabIndex="6"
                        ...
                        <fieldset id="fieldset1" width="90%" runat="server" class="FieldSet">
                            <table width="90%" cellspacing="6">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="TxtPropertyType" runat="server" CssClass="TextBox"  Width="90%" TabIndex="2"></asp:TextBox>
                                        <asp:Label ID="lblPropertyType" Text="*" ForeColor="Red" runat="server"></asp:Label>                                         
                                        <asp:HiddenField ID="hdnValue" OnValueChanged="hdnValue_ValueChanged" runat="server" />
                                        <div id="div1">
                                        </div>
                                    </td>
                                    <td>
                                        <asp:RequiredFieldValidator ID="Req1" runat="server" ControlToValidate="TxtPropertyType"
                                            Display="None" ErrorMessage="PropertyType is Required" SetFocusOnError="True" ValidationGroup="Add"></asp:RequiredFieldValidator>
                                        <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender2" runat="server" Enabled="True"
                                         ...
                                         <ajax:AutoCompleteExtender ID="ACE1" runat="server" TargetControlID="TxtPropertyType" CompletionInterval="100"
