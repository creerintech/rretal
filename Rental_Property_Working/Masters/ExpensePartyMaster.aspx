<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true" CodeFile="ExpensePartyMaster.aspx.cs" 
Inherits="Masters_ExpensePartyMaster" Title="Expense Party Master" %>
 ...
 <input type="hidden" id="hiddenbox" runat="server" value="" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        function UpdateEquipFunction() {
            ...
            var value = document.getElementById('<%=txtExpense.ClientID%>').value;
                        ...
                        <fieldset id="fieldset" runat="server" class="FieldSet">
                            <table width="100%" cellspacing="6">
                                ...
                                <td class="Label">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlExpenseHead" runat="server" Width="250px" AutoPostBack="true" TabIndex="1"
                                           >
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="ReqProjectName" runat="server" ControlToValidate="ddlExpenseHead"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtExpense" runat="server" CssClass="TextBox" Height="18px" MaxLength="50"
                                            Width="368px" TabIndex="1"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:RequiredFieldValidator ID="Req1" runat="server" ControlToValidate="txtExpense"
                                            Display="None" ErrorMessage="Expense Is Required" SetFocusOnError="True" ValidationGroup="Add">
                                        </asp:RequiredFieldValidator>
                                 ...
                                 <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtNarration" runat="server" CssClass="TextBox" Height="18px" MaxLength="50"
                                            Width="368px" TabIndex="1"></asp:TextBox>
                                    </td>
                                    <td>                                      
                                    </td>
