<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage_RN.master" AutoEventWireup="true"
    CodeFile="PropertySubTypeMaster.aspx.cs" Inherits="Masters_PropertySubTypeMaster" Title="PropertySubType Master" %>
                        ...
                        <fieldset id="fieldset1" width="90%" runat="server" class="FieldSet">
                            <table width="90%" cellspacing="6">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="TxtPropertySubType" runat="server" CssClass="TextBox" Width="90%"
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ID="Req1" runat="server" ControlToValidate="TxtPropertySubType"
                                            Display="None" ErrorMessage="PropertySubType is Required" SetFocusOnError="True"
                                        ...
                                        <ajax:AutoCompleteExtender ID="ACE1" runat="server" TargetControlID="TxtPropertySubType" CompletionInterval="100"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPropertyType" runat="server" CssClass="ComboBox" Width="90%"
                                            TabIndex="2">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="ReqEMP" runat="server" ControlToValidate="ddlPropertyType"
                                            Display="None" ErrorMessage="Property Type Is Required" SetFocusOnError="True"
