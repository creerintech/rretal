<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MenustripDemobyAnkush1.ascx.cs"
    Inherits="Controls_MenustripDemobyAnkush" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<nav>
	<ul>
		<li><a href="../Masters/HomeNew.aspx">Home</a></li>
		<li><a href="#">Masters</a>
			<ul> 
                ...
                <li><a href="../Masters/BrokerMaster.aspx">Broker Master</a></li>	
			...
			<li><a href="../Masters/Salutation.aspx">Salutation Master</a></li>
				 <li><a href="../Masters/CustomerMaster.aspx">Customer Master</a></li>
			
				<li><a href="../Masters/ProjectSaleRate.aspx">Project Sale Rate</a></li>	
			    <li><a href="../Masters/ProjectStages.aspx">Project Stages</a></li>	
                <li><a href="../Transactions/PaymentScheduleTemplate.aspx">Payment Schedule Template</a></li>			
