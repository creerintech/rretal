...
{
public class DMMISBrokerWise:Utility.Setting
{
    ...
    public DataSet FillCombo(int EmpID, out string StrError)
    {
        ...
        try
        {
            ...
            DS = SQLHelper.GetDataSetDoubleParm(_Connection, _Transaction, CommandType.StoredProcedure, "MIS_BrokerWiseDetails", pAction, pEmpID);
    ...
    public DataSet GetBuilding(int ID, out string strError)
    {
        ...
        try
        {
            ...
            Open(CONNECTION_STRING);
            Ds = SQLHelper.GetDataSetDoubleParm(_Connection, _Transaction, CommandType.StoredProcedure, "MIS_BrokerWiseDetails", pAction, pId);
    ...
    public DataSet GetFlatsWithoutEmp(string str, int PCId, out string strError)
    {
        ...
        try
        {
            ...
            Open(CONNECTION_STRING);
            Ds = SQLHelper.GetDataSet(_Connection, _Transaction, CommandType.StoredProcedure, "MIS_BrokerWiseDetails", param);
