<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReceiptForExpOutstanding.aspx.cs" Inherits="Transactions_ReceiptForExpOutstanding" Title="Receipt ExpOutstanding" %>
          ...
          <table width="100%">
                ...
                <tr>
                    ...
                    <td style="height: 22px">
                     ...
                     <asp:DropDownList ID="ddlPROPERTYTo" runat="server" CssClass="ComboBox" Width="250px" OnSelectedIndexChanged="ddlPROPERTYTo_SelectedIndexChanged" AutoPostBack="true"
                            TabIndex="4">
                        </asp:DropDownList>
                    ...
                    <td style="height: 22px">
                       <asp:DropDownList ID="ddlReceivedFrom" runat="server" CssClass="ComboBox" Width="250px" OnSelectedIndexChanged="ddlReceivedFrom_SelectedIndexChanged" AutoPostBack="true"
                            TabIndex="2">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="Display_None" width="100px">
                        For The Month Of :
                    </td>
                    <td style="width: 377px" class="Display_None">
                        <asp:TextBox ID="txtMonthDate" runat="server" CssClass="TextBox" TabIndex="8" OnTextChanged="txtMonthDate_TextChanged" AutoPostBack="true" ></asp:TextBox>
                      ...
                      <td class="Label" style="width: 121px">
                    ...
                    <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlExpenseName" runat="server" Width="200px" OnSelectedIndexChanged="ddlExpenseName_SelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                    ...
                    <td colspan="3">
                        ...
                        &nbsp;<asp:Label ID="lll" CssClass="Label" Text="Amount In Words : " runat="server"></asp:Label><asp:TextBox
                            ID="txtAmtinWord" runat="server" BorderStyle="None" Font-Size="11px" Width="586px"
                    ...
                    <%--    </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtAmtInWrds" runat="server" CssClass="TextBox" Width="550px"></asp:TextBox>
                            </td>
                        </tr>--%>
                    <tr>
                        <td class="Label">
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <asp:Button ID="BtnCancel" runat="server" Text="Cancel" CssClass="button" CausesValidation="False"
                                    TabIndex="24"  OnClick="BtnCancel_Click"/>
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <a href='../PrintReport/PrintReports.aspx?ID=<%# Eval("#")%>&amp;Flag=<%="ExpOutReceipt"%>'
                                                    target="_blank">
                                            ...
                                            CommandArgument='<%# Eval("#") %>' CommandName="Email" CssClass="Imagebutton" 
                                            ImageUrl="~/Images/Icon/Grid-e-mail.png" TabIndex="1" ToolTip="Email Receipt" />
                                        ...
                                        <asp:BoundField HeaderText="ForTheMonth" DataField="ForTheMonth">
                                            <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle"  CssClass="Display_None"/>
