<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true"
    CodeFile="ExpenseOutstanding.aspx.cs" Inherits="Transactions_ExpenseOutstanding" Title="Expense Outstanding" %>
                                        ...
                                        <div style="overflow: scroll; width: 840px">
                                            <asp:GridView ID="GrdExpDtls" runat="server" AutoGenerateColumns="False" CaptionAlign="Top"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Narration" DataField="Remark">
                                                        <HeaderStyle Wrap="false" HorizontalAlign="Left" />
                                                        <ItemStyle Wrap="false" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                </Columns>
